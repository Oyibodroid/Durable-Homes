...
const resend = new Resend(process.env.RESEND_API_KEY || 're_9ec8VcQW_HjEYwmt8dtrZ95Cv4VtZBzQv')
const FROM = process.env.RESEND_FROM_EMAIL ?? 'noreply@durablehomes.com'
const APP_URL = process.env.NEXT_PUBLIC_APP_URL ?? 'https://durablehomes.vercel.app'
