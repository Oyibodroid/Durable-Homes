...
export default function SignInPage() {
  ...
  // When this is set, the unverified banner is shown with a resend option
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        const { verified: isVerified, exists } = await checkRes.json()

        if (exists && !isVerified) {
          // Show inline banner with resend option instead of just a toast
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="mt-2 inline-flex items-center gap-1.5 text-sm font-medium text-amber-800 underline hover:no-underline disabled:opacity-60"
                  >
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <GoogleIcon />
              {isSocialLoading === 'google' ? 'Redirecting...' : 'Continue with Google'}
            </button>
            <button
              type="button"
            ...
            >
              <GitHubIcon />
              {isSocialLoading === 'github' ? 'Redirecting...' : 'Continue with GitHub'}
            </button>
          </div>
