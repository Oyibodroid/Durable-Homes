                  ...
                  <div className="bg-white border border-gray-100 p-7">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Image src="/Paystack_Logo.png" alt="Paystack" width={24} height={24} className="object-contain" />
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Image src="/Flutterwave_Logo.png" alt="Flutterwave" width={24} height={24} className="object-contain" />
