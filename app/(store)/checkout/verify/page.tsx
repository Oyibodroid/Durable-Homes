...
function VerifyContent() {
  ...
  useEffect(() => {
    ...
    window.location.href = `/api/payments/verify?reference=${encodeURIComponent(reference)}`
  }, [router, searchParams])
...
// Explicit default export assignment at the bottom of the scope file to clear the AppPageConfig error
